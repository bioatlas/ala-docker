...
CREATE OR REPLACE FUNCTION export_images() RETURNS void AS $$
    BEGIN
        ...
        (
            ...
            CONCAT( 'http://molecular.infrabas.se/images/image/proxyImageThumbnailLarge?imageId=', image_identifier) AS identifier,
            creator AS creator,
            ...
            CONCAT('http://molecular.infrabas.se/images/image/details/', image_identifier) AS "references"
            from image
