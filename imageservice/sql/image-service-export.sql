...
CREATE OR REPLACE FUNCTION export_images() RETURNS void AS $$
    BEGIN
        ...
        (
            ...
            CONCAT( 'https://images.bioatlas.se/image/proxyImageThumbnailLarge?imageId=', image_identifier) AS identifier,
            ...
            CONCAT('https://images.bioatlas.se/image/', image_identifier) AS "references",
            regexp_replace(title, E'[\\n\\r]+', ' ', 'g' ) as title,
